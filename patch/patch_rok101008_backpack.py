...
# Inject backpack
p.splice('../backpack/backpack.bin', 0x01056000);
p.thumb_bl(0x01043232, 0x01056000); # init
p.thumb_bl(0x0103dec6, 0x01056002); # uart2 rx int

# Inject process descriptor
pd = p.getl(0x01056004)
print 'Descriptor at %08x' % pd
p.setl(0x01043da4, pd)

# Register process PCB
pcb = p.getl(0x01056008)
